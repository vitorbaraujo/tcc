...
\begin{figure}%
    \centering
    \subfloat[Jogo original sendo executado em um PC.]{{\includegraphics[width=16cm]{figuras/tw-original-1.eps} }}%
    \qquad
    \subfloat[Protótipo sendo executado no emulador de GBA.]{{\includegraphics[width=16cm]{figuras/tw-gba-1.eps} }}%
...
O protótipo desenvolvido está disponível no seguinte repositório: \url{https://bit.ly/2BQV6jf}
