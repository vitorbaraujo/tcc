...
\vspace{\onelineskip}
\begin{lstlisting}[caption={Código-fonte do módulo de \textit{input}.}]
#include "input.h"
...
\vspace{\onelineskip}
\begin{lstlisting}[caption={Código de teste de \textit{input}.}]
#include "video.h"
#include "input.h"
