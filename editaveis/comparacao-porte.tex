...
\begin{figure}%
    ...
    \qquad
    \subfloat[Menu portado. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-menu.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Primeira fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase1.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Segunda fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase2.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Terceira fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase3.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Quarta fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase4.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Quinta fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase5.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Sexta fase portada. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-fase6.eps} }}%
...
\begin{figure}%
    ...
    \qquad
    \subfloat[Menu de vitória portado. Fonte: \textit{Autores}.]{{\includegraphics[width=12cm]{figuras/comparacao/gba-vitoria.eps} }}%
