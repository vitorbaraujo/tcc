...
\end{minted}
\makebox[\linewidth]{Construtor da classe \textit{Texture}. Fonte: \textit{Autores}.}
\vspace{\onelineskip}
...
\end{minted}
\makebox[\linewidth]{Construtor por cópia da classe \textit{Texture}. Fonte: \textit{Autores}.}
\vspace{\onelineskip}
...
\end{minted}
\makebox[\linewidth]{Função de alocação da paleta de cores de uma textura. Fonte: \textit{Autores}.}
\vspace{\onelineskip}
...
\end{minted}
\makebox[\linewidth]{Função de alocação das \textit{sprites} de uma textura. Fonte: \textit{Autores}.}
\vspace{\onelineskip}
...
\end{minted}
\makebox[\linewidth]{Função de cópia dos metadados das texturas. Fonte: \textit{Autores}.}
\vspace{\onelineskip}
